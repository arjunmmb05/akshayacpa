        ...
        <div className="flex flex-col lg:flex-row gap-20 items-start">
            ...
            <div className="h-[750px] overflow-hidden relative mask-fade-edges-vertical">
              ...
              >
                {[...reviews, ...reviews].map((review, idx) => (
                  <div key={idx} className="bg-white/5 backdrop-blur-3xl p-10 rounded-[3rem] border border-white/10 hover:bg-white/10 transition-all duration-500 group relative overflow-hidden">
          ...
          <div className="lg:w-[35%] w-full lg:sticky lg:top-32">
            <motion.div 
               ...
               viewport={{ once: true }}
               className="bg-white p-10 md:p-12 rounded-[3.5rem] shadow-2xl relative overflow-hidden"
            >
